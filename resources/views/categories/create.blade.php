...
<div class="max-w-3xl mx-auto mt-12 bg-white shadow-xl rounded-2xl p-8">
    ...
    <form method="POST" action="{{ route('categories.store') }}">
        ...
        <div class="mb-6">
            <label for="name" class="block text-gray-700 font-semibold mb-1">{{ __('categories.name') }}</label>
        ...
        <div class="mb-8">
            <label for="description" class="block text-gray-700 font-semibold mb-1">{{ __('categories.description') }}</label>
